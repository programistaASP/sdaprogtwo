...
public class CurrencyDataWriter {
    public static void saveToFile(final String path, final Collection<CurrencyData> currencyData) throws IOException {
    ...
    private static String mapToCSV(final CurrencyData currencyData) {
